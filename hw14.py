...
# 3) записали с помощью pickle mary в фаил
#
#
...
#
#
# 4) открыли фаил HW14export в режиме побайтового чтения
# 5) с помощью pickle преобразовали поток байтов из файла в объект Python, а иммено в экземпляр
